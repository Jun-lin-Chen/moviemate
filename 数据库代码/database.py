    ...
    try:
        with database_connection(host, user, password, port, database, charset) as connection:
            with connection.cursor() as cursor:
                ...
                print("准备删除数据...")
                delete_movie_title = input('请输入要删除的电影名称：')
                ...
                print("准备更新数据...")
                update_movie_title = input('请输入要更新的电影名称：')
                if update_movie_title.strip():
                    update_movie_grade = input('请输入更新后的评分')
                    if update_movie_grade.strip():
                ...
                print("准备查询数据...")
                search_movie_title = input('请输入要查询的电影名称')
